# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 09:55:17 2024
...
def separate_faces(image):
    # 6038 face selection rectangles
    rects = [(728, 0, 2526, 157),
             (450, 160, 2800, 385),
             (450, 590, 2800, 378),
             (450, 1098, 2800, 349),
             (450, 1509, 2800, 415),
...
def process_6038step2(image, drawable):
    ######################################
    # Manually Use Difference of Gaussians
    ######################################
    
    # Overlay the appropriate reference mask and subtract everything unnecessary
    # filename = "C:/Users/Ryan.Larson.ROCKWELLINC/github/color-deviation/masks/reference_masks/6038_ref_mask.png"
    config = load_config()
    filename = config.get("6038_ref_mask")
