# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 09:41:17 2024
...
def process_6024step3(image, drawable):    
    ###########################################################
    ...
    pdb.gimp_image_remove_layer(image, image.layers[5])
    pdb.gimp_image_remove_layer(image, image.layers[4])
...
def register_script():
    register(
        ...
        "Your License",
        "2024",
        "<Image>/Filters/Custom/6024 Step 3",
